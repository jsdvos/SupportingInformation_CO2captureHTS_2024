...
'''
System: N2 inside the COF-5 framework.

This requires that YAFF is installed, which can be found here:
...
class MM3Interaction(object):
    def __init__(self, host, guest):
        ...
        self.ff = ForceField.generate(self.system, 'pars_COF-5_n2_mm3.txt')
...
if __name__=='__main__':
    host = 'COF-5'
    guest = 'n2'
    print("Running demonstration for the adsorption of n2 in COF-5...")
    T = 298.0*kelvin
