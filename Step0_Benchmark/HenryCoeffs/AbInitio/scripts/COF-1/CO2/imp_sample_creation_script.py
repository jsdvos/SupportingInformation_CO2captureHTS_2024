...
'''
System: CO2 inside the COF-1 framework.
...
class MM3Interaction(object):
    def __init__(self, host, guest):
        ...
        self.ff = ForceField.generate(self.system, 'pars_COF-1_co2_mm3.txt')
...
if __name__=='__main__':
    host = 'COF-1'
    guest = 'co2'
    print("Running demonstration for the adsorption of co2 in COF-1...")
    T = 298.0*kelvin
    nsamples_widom = 1000000
    nsamples_importance = nsamples_widom/1000
    ####### Construct a MM3CAP for this host+guest
    ...
    # Note that the number of samples can be substantially smaller that what is required for the Widom insertion
